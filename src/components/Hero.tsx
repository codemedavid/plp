                ...
                if (slide.kind === 'referral') {
                  return (
                    <div
                      key="referral-slide"
                      ref={(el) => { slideRefs.current[i] = el; }}
                      className="shrink-0 flex flex-col items-center justify-center gap-4 sm:gap-5 px-6 py-10 sm:py-16 text-center bg-cream-light"
                      style={{ flex: '0 0 100%' }}
                    >
                      <span className="text-[10px] sm:text-[12px] font-semibold uppercase tracking-[0.28em] sm:tracking-[0.32em] text-gold-600">
                        Earn Monthly
                      ...
                      <a
                        href="/user/profile"
                        className="group/cta mt-1 inline-flex items-center gap-3 bg-navy-900 px-7 py-3 sm:px-11 sm:py-4 text-[11px] sm:text-[13px] font-semibold uppercase tracking-[0.28em] text-cream-light transition-colors hover:bg-gold-500 hover:text-navy-900"
                        style={{ borderRadius: '2px' }}
                      >
                        Share Your Code
                        <ArrowRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 transition-transform group-hover/cta:translate-x-1" strokeWidth={1.8} />
                      </a>
                      <p className="text-[11px] uppercase tracking-[0.14em] text-charcoal-500 sm:text-xs">
